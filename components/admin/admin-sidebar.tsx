...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-64 shrink-0 border-r border-neutral-800 bg-black text-white">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4">
          {groups.map((group) => (
            <div key={group.title} className="mb-6">
              <p className="px-2 pb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-neutral-500">
                {group.title}
              </p>
